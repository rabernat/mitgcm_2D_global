...
C------------begin Nathaniel LAVD + LADIV 2018 hack ------------------
C     lavd        :: the lavd of the particle
C     ladiv       :: the lagrangian-averaged horiz. vel. divergence of the particle      
      ...
      _RL      ladiv(max_npart_tile,nSx,nSy)      
...
C-----------end Nathaniel LAVD + LADIV 2018 hack --------------------
C---  +----1----+----2----+----3----+----4----+----5----+----6----+----7-|--+----|
